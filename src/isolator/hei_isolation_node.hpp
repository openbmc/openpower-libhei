...
class IsolationNode
{
  ...
  private: // Isolation stack and supporting functions.
    ...
    /**
     * @brief  First, checks if this node already exists in cv_isolationStack.
     *         If not, pushs this node to the top of the stack.
     * @return True, if this node already exists in cv_isolationStack. False,
     *         otherwise.
     */
    bool pushIsolationStack() const;
