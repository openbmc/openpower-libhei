...
/**
\mainpage The ChipDataStream class
...
class ChipDataStream
{
  ...
  private:
      ...
      /** iv_buffer points to a binary data buffer. It is initialized
          when the ChipDataStream class is instantiated then never
          changes. **/
  ...
  public:
      ...
      **/
      ...
      /**
      *@brief Default case for "operator>>" template.  This template extracts
      *       the integral data types; bool, char, uint8_t, and int8_t
      *@param             D:       A type (bool, char, uint8_t, or int8_t)
