...
/** The given register type is unsupported by the user application. */
static constexpr ReturnCode RC_REG_ACCESS_UNSUPPORTED  = ReturnCode(0x00000004);

/** Generic return code indicating something along the register access path
 *  failed and the returned data is undefined and should not be used. */
static constexpr ReturnCode RC_REG_ACCESS_FAILURE      = ReturnCode(0x00000005);
