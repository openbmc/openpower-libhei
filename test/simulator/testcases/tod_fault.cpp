...
REG_SCOM(proc0, 0x00040030, 0xf000000000000000) // TOD_ERRORREGISTER
REG_SCOM(proc0, 0x00040032, 0xc000000000000000) // TOD_ERRORMASK
REG_SCOM(proc0, 0x00040033, 0xa000000000000000) // TOD_ERRORACTION

EXP_SIG(proc0, 0x47a4, 0, 3, CHECKSTOP)
