...
#define CONSTANT1 0x1234        //edcb
#define CONSTANT2 0xabcd        //5432
...
int main()
{
    ...
    cout << "0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4) << 
                    hex << uppercase << constant1 << "\n";
    ...
    cout << "Leftside:  ";
    cout << "0x" << setfill('0')<<setw(BITSTRING_BIT_WIDTH/4)<<hex<<leftside.
                    getBitString(my_chip)->getFieldRight(0,BITSTRING_BIT_WIDTH);

    cout << "  Rightside:  ";
    cout << "0x" << setfill('0')<<setw(BITSTRING_BIT_WIDTH/4)<<hex<<rightside.
                    getBitString(my_chip)->getFieldRight(0,BITSTRING_BIT_WIDTH);
    cout << "\n\n";
    ...
    cout << "0x" << setfill('0')<<setw(BITSTRING_BIT_WIDTH/4)<<hex
         << my_and_register.getBitString(my_chip)->
            getFieldRight(0,BITSTRING_BIT_WIDTH) << "\n\n";
    ...
    cout << "NOT result:               ";
    cout << "0x" << setfill('0')<<setw(BITSTRING_BIT_WIDTH/4)<<hex
         <<my_not_register.getBitString(my_chip)->
           getFieldRight(0,BITSTRING_BIT_WIDTH) << "\n\n";
    ...
    cout << "0x" << setfill('0')<<setw(BITSTRING_BIT_WIDTH/4)<<hex
         <<my_leftshift_register.getBitString(my_chip)->
           getFieldRight(0,BITSTRING_BIT_WIDTH) << "\n\n";
    ...
    cout << "0x" << setfill('0')<<setw(BITSTRING_BIT_WIDTH/4)<<hex
         <<my_rightshift_register.getBitString(my_chip)->
           getFieldRight(0,BITSTRING_BIT_WIDTH) << "\n\n";
    ...
    cout << "OR result:         ";
    cout << "0x" << setfill('0')<<setw(BITSTRING_BIT_WIDTH/4)<<hex
         <<my_or_register.getBitString(my_chip)->
           getFieldRight(0,BITSTRING_BIT_WIDTH) << "\n\n";
    ...
    cout << "0x" << setfill('0')<<setw(BITSTRING_BIT_WIDTH/4)<<hex<<
                    constreg1.getBitString(my_chip)->
                    getFieldRight(0,BITSTRING_BIT_WIDTH) << ")\n";
    ...
    cout << "0x" << setfill('0')<<setw(BITSTRING_BIT_WIDTH/4)<<hex<<
                    constreg2.getBitString(my_chip)->
                    getFieldRight(0,BITSTRING_BIT_WIDTH) << ")\n";
    ...
    cout << "and_register2 = ";
    cout << "0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<hex<<
                    and_register2.getBitString(my_chip) ->
                    getFieldRight(0,BITSTRING_BIT_WIDTH) << "\n";
    ...
    cout << "not_register2 = ";
    cout << "0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<hex<<
                    not_register2.getBitString(my_chip) ->
                    getFieldRight(0,BITSTRING_BIT_WIDTH) << "\n";
    ...
    cout << "0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<hex<<
                    leftshift_register2.getBitString(my_chip) ->
                    getFieldRight(0,BITSTRING_BIT_WIDTH) << "\n";
    ...
    cout << "0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<hex<<
                    rightshift_register2.getBitString(my_chip) ->
                    getFieldRight(0,BITSTRING_BIT_WIDTH) << "\n";
    ...
    cout << "or_register1 = ";
    cout << "0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<hex<<
                    or_register1.getBitString(my_chip) ->
                    getFieldRight(0,BITSTRING_BIT_WIDTH) << "\n";
    ...
    cout << "or_register2 = ";
    cout << "0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<hex<<
                    or_register2.getBitString(my_chip) ->
                    getFieldRight(0,BITSTRING_BIT_WIDTH) << "\n";
    ...
    cout << " Constant    0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<
              hex << cr1.getBitString(my_chip) ->
                     getFieldRight(0,BITSTRING_BIT_WIDTH);
    cout << "     0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<hex<<
                    cr2.getBitString(my_chip) ->
                    getFieldRight(0,BITSTRING_BIT_WIDTH);
    if (cr1 == cr2) cout << "      Equal\n";
    else cout << "      Not Equal\n";
    ...
    cout << " And         0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<
              hex<<and1.getBitString(my_chip) ->
              getFieldRight(0,BITSTRING_BIT_WIDTH);
    cout << "     0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<hex<<
              and2.getBitString(my_chip) ->
              getFieldRight(0,BITSTRING_BIT_WIDTH);
    if (and1 == and2)
        cout << "      Equal\n";
    else
    ...
    cout << " Not         0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<
              hex<<nr1.getBitString(my_chip) ->
              getFieldRight(0,BITSTRING_BIT_WIDTH);
    cout << "     0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<hex<<
                    nr2.getBitString(my_chip) ->
                    getFieldRight(0,BITSTRING_BIT_WIDTH);
    if (nr1 == nr2) cout << "      Equal\n";
    else cout << "      Not Equal\n";
    ...
    cout << " Left Shift  0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<
              hex<<lsr1.getBitString(my_chip) ->
              getFieldRight(0,BITSTRING_BIT_WIDTH);
    cout << "     0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<hex<<
                    lsr2.getBitString(my_chip) ->
                    getFieldRight(0,BITSTRING_BIT_WIDTH);
    if (lsr1 == lsr2) cout << "      Equal\n";
    else cout << "      Not Equal\n";
    ...
    cout << " Right Shift 0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<
              hex<<rsr1.getBitString(my_chip) ->
              getFieldRight(0,BITSTRING_BIT_WIDTH);
    cout << "     0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<hex<<
                    rsr2.getBitString(my_chip) ->
                    getFieldRight(0,BITSTRING_BIT_WIDTH);
    if (rsr1 == rsr2) cout << "      Equal\n";
    else cout << "      Not Equal\n";
    ...
    cout << " OR          0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<
              hex<<or1.getBitString(my_chip) ->
              getFieldRight(0,BITSTRING_BIT_WIDTH);
    cout << "     0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<hex<<
                    or2.getBitString(my_chip) ->
                    getFieldRight(0,BITSTRING_BIT_WIDTH);
    if (or1 == or2) cout << "      Equal\n";
    else cout << "      Not Equal\n";
    ...
    cout << " Constant    0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<
              hex<<cr1a.getBitString(my_chip) ->
              getFieldRight(0,BITSTRING_BIT_WIDTH);
    cout << "     0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<hex<<
                    cr2a.getBitString(my_chip) ->
                    getFieldRight(0,BITSTRING_BIT_WIDTH);
    if (cr1a < cr2a) cout << "      Less Than\n";
    ...
    cout << " And         0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<
              hex<<and1a.getBitString(my_chip) ->
              getFieldRight(0,BITSTRING_BIT_WIDTH);
    cout << "     0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<hex<<
                    and2a.getBitString(my_chip) ->
                    getFieldRight(0,BITSTRING_BIT_WIDTH);
    if (and2a < and1a) cout << "      Less Than\n";
    else cout << "      Not Less Than\n";
    ...
    cout << " Not         0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<
              hex<<nr1a.getBitString(my_chip) ->
              getFieldRight(0,BITSTRING_BIT_WIDTH);
    cout << "     0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<hex<<
                    nr2a.getBitString(my_chip) ->
                    getFieldRight(0,BITSTRING_BIT_WIDTH);
    if (nr1a < nr2a) cout << "      Less Than\n";
    else cout << "      Not Less Than\n";
    ...
    cout << " Left Shift  0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<
              hex<<lsr1a.getBitString(my_chip) ->
              getFieldRight(0,BITSTRING_BIT_WIDTH);
    cout << "     0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<hex<<
                    lsr2a.getBitString(my_chip) ->
                    getFieldRight(0,BITSTRING_BIT_WIDTH);
    if (lsr1a < lsr2a) cout << "      Less Than\n";
    else cout << "      Not Less Than\n";
    ...
    cout << " Right Shift 0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<
              hex<<rsr1a.getBitString(my_chip) ->
              getFieldRight(0,BITSTRING_BIT_WIDTH);
    cout << "     0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<hex<<
                    rsr2a.getBitString(my_chip) ->
                    getFieldRight(0,BITSTRING_BIT_WIDTH);
    if (rsr1a < rsr2a) cout << "      Less Than\n";
    else cout << "      Not Less Than\n";
    ...
    cout << " Or          0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<
              hex<<or1a.getBitString(my_chip) ->
              getFieldRight(0,BITSTRING_BIT_WIDTH);
    cout << "     0x" << setfill('0') << setw(BITSTRING_BIT_WIDTH/4)<<hex<<
                    or2a.getBitString(my_chip) ->
                    getFieldRight(0,BITSTRING_BIT_WIDTH);
    if (or1a < or2a) cout << "      Less Than\n";
    else cout << "      Not Less Than\n";
